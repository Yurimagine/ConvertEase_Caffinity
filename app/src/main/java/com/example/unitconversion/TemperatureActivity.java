...
public class TemperatureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, ConversionUtils.temperatureUnits);
    ...
    private void convertUnits() {
        ...
        double result = ConversionUtils.convert(value, fromUnit, toUnit, "temperature");
        ...
        // Save to history
        prefHelper.saveHistoryEntry(new SharedPrefHelper.HistoryEntry("temperature", fromUnit, toUnit, value, result, System.currentTimeMillis()));
