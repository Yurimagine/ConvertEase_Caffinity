...
public class WeightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<String> units = new ArrayList<>(ConversionUtils.weightUnits.keySet());
    ...
    private void convertUnits() {
        ...
        double result = ConversionUtils.convert(value, fromUnit, toUnit, "weight");
        ...
        // Save history
        prefHelper.saveHistoryEntry(new SharedPrefHelper.HistoryEntry("weight", fromUnit, toUnit, value, result, System.currentTimeMillis()));
